...
export const games: Game[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'One wrong tap (or timeout) and the run ends',
    ],
    sensors: ['TOUCH'],
    category: 'TOUCH',
    iconText: '◧',
  ...
  },
  {
    ...
    name: 'REACTION LIGHT',
    shortName: 'REACT',
    tagline: 'Tap green before the window closes. It keeps shrinking.',
    description:
      'The screen sits red. After a random delay it flips green for a brief window — tap before it closes. Each round the green window gets shorter. Tap during red and you bust. Tap too late and you bust. Round 6+ adds fake-color flashes that aren\'t green but want you to think they are.',
    rules: [
      'Wait through the red',
      'When green flashes, tap before the window closes',
      'Tap during red = bust',
      'Miss the window = bust',
      'Each round the green window shrinks',
      'Past round 6: pink / orange / yellow distractors flash to fake you out',
